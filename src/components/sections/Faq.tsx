  ...
  return (
    <section id="faq" className="faq-section section-space" aria-labelledby="faq-title">
      <div className="shell faq-grid">
        <div><span className="section-label"><span>08 /</span> Straight answers</span><h2 id="faq-title" className="section-title">The questions people<br /><span className="muted-heading">ask before they say yes.</span></h2></div>
